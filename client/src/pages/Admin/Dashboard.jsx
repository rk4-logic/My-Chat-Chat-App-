...
const Dashboard = () => {
  ...
  const Appbar = <Paper elevation={3} sx={{ padding: '2rem', margin: '2rem 0', borderRadius: '2rem' }} >
  ...
  return (
    <AdminLayout>
      <Container component={'main'} maxWidth='lg' >
        ...
        <Stack direction={{ xs: 'column', md: 'row' }}  flexWrap={'wrap'} justifyContent={'center'} alignItems={{ xs: 'center', md: 'stretch' }} sx={{gap: '2rem'}} >
          <Paper
            elevation={3}
            sx={{
              padding: '2rem 3.5rem',
